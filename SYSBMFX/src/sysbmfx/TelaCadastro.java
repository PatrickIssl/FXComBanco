...
public class TelaCadastro implements Initializable {
    ...
    @FXML
    private void onclickIncluirSemDespacho(ActionEvent event){
        incluir(0);
    }
    
    @FXML
    private void onclickIncluirEDespachar(ActionEvent event){
        System.out.println("despachar");
    }
    
    @FXML
    private void onclickIncluir(ActionEvent event){
        incluir(1);
    }

    private void incluir( int i) {
        ...
        String numouKm = txtnumouKm.getText();
      ...
      try {
             ...
             preparedStatement.setString(14, numouKm);
             preparedStatement.setString(15, esquina);
             preparedStatement.setString(16, pontoReferencia);
