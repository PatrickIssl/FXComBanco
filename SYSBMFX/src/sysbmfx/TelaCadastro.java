...
public class TelaCadastro implements Initializable {
    ...
    private void incluir(int i) throws SQLException {
        ...
        if (datefield.getText().equals("")) {
            ...
            alert.showAndWait();
        } else if (comboNatureza.getSelectionModel().getSelectedItem() == null) {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Erro");
            alert.setHeaderText("Selecione uma natureza do evento");
            alert.showAndWait();
        } else if (comboSubnatureza.getSelectionModel().getSelectedItem() == null) {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Erro");
